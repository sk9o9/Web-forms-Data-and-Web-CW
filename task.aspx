    ...
    <div class="container">
        ...
        <div class="row mb-4">
            <div class="col">
                ...
                <p class="text-muted">Add, edit, and manage task information</p>
            </div>
        </div>
        ...
        <form id="form1" runat="server">
            ...
            <div class="card mb-4">
                <div class="card-header bg-success text-white">
                    <h5 class="mb-0">Add/Edit Task</h5>
                </div>
                <div class="card-body">
                    <asp:FormView ID="FormView1" runat="server" DataKeyNames="TASK_ID" 
                        ...
                        <EditItemTemplate>
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <asp:Label ID="TASK_IDLabel1" runat="server" Text='<%# Eval("TASK_ID") %>' CssClass="form-control-plaintext" />
                                </div>
                                <div class="col-md-6">
                        ...
                        <InsertItemTemplate>
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label fw-bold">Task Name:</label>
                                    <asp:TextBox ID="TASK_NAMETextBox" runat="server" Text='<%# Bind("TASK_NAME") %>' CssClass="form-control" placeholder="Enter task name" />
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-bold">Start Date:</label>
